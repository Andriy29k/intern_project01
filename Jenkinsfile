        ...
        stage('Docker images build') {
            steps {
                withCredentials([usernamePassword(
                    ...
                    sh "sudo docker build -t $DOCKERHUB_USERNAME/$BACKEND_IMAGE_NAME:$IMAGE_TAG ./backend"
                    sh "sudo docker build -t $DOCKERHUB_USERNAME/$FRONTEND_IMAGE_NAME:$IMAGE_TAG ./frontend"
                    sh "sudo docker push $DOCKERHUB_USERNAME/$BACKEND_IMAGE_NAME:$IMAGE_TAG"
                    sh "sudo docker push $DOCKERHUB_USERNAME/$FRONTEND_IMAGE_NAME:$IMAGE_TAG"
                }
            }
        }
